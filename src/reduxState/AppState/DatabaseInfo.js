...
Il faut remplacer les 3 ptits points AppState par le nom de la page / du component correspondant.
...
export const rowNamesAndTypes = {
  ...
  // l'écran actuellement affiché dans AppState.js
  chosenOne: "TEXT",

  // la page AppState.js est prêt à être affichée ?
  isMounted: "INTEGER",
