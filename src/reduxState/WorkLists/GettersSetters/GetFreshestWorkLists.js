...
/**
 *
 * permet d'obtenir les plus récents WorkLists stockés dans Redux/Sqlite
 *
 ...
 *
 */
export const GetFreshestWorkLists = () => {
  return useSelector((state) => state.WorkLists.allRows);
};
