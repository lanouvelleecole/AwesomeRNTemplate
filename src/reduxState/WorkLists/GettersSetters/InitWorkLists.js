...
// Le AsyncThunk de récupération/triage de toutes les données stockées dans WorkLists.
 ...
 *
 * @returns la liste de tous les WorkLists (rows {key: value}).
 *
 ...
 */
export const InitWorkLists = ({ onSuccess, onError, debugMode }) => {
