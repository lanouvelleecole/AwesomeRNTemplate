...
// Le AsyncThunk de modification/triage de toutes les données stockées dans WorkLists.
...
export const UpdateSpecificRowsFromDB = ({
  ...
  // stringify works, et workListData
  // de array/map à string
  const stringifiedRow = {
    ...row,
    works: JSON.stringify(row.works),
    workListData: JSON.stringify(row.workListData),
  };
